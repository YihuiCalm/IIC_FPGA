...
HD_PWD='D:/Github/IIC_FPGA/IIC_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IIC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IIC_top.tcl -notrace
