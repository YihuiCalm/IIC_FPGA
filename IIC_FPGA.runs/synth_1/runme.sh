...
HD_PWD='D:/Github/IIC_FPGA/IIC_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IIC_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IIC_top.tcl
