...
REM
REM Generated by Vivado on Tue May 02 18:35:55 -0400 2023
...
echo "xvlog --incr --relax -prj IIC_top_tb_vlog.prj"
call xvlog  --incr --relax -prj IIC_top_tb_vlog.prj -log xvlog.log
